...
class _Child(BaseViewSet, mixins.CreateModelMixin,
             mixins.UpdateModelMixin, mixins.DestroyModelMixin):
    """Vue de base partagée par toutes les sous-ressources."""
    def get_queryset(self):
        return self.model.objects.filter(cv_id=self.kwargs["cv_pk"], user=self.request.user)
